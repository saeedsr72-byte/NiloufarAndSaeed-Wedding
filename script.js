...
const translations = {
  en: { eyebrow:'A new chapter begins', date:'Tuesday — September 1, 2026 / 7:00 PM', countdownTitle:'Until our day', days:'Days', hours:'Hours', minutes:'Minutes', seconds:'Seconds', storyKicker:'Two hearts, one beginning', storyTitle:'We would love to celebrate with you.', venueKicker:'The celebration', venueName:'Ashkan Garden', venueAddress:'Shiraz - Qalat Road - Aghaghia 2 Alley - Ashkan Garden', map:'Open location', mapKicker:'Navigation', mapTitle:'Choose your map', rsvpTitle:'Will you be joining us?', rsvpTap:'Tap for respond', namePlaceholder:'Full name', attendanceQuestion:'Will you be joining us?', attendanceYes:"With love, I'll be there", attendanceNo:"I won't be able to join you this time", noteLabel:'Your note', notePlaceholder:'Write a message for us...', submitRsvp:'Send RSVP', rsvpSuccess:'Thank you for letting us know ♥', rsvpError:'Something went wrong. Please try again.' },
