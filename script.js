...
const translations = {
  en: { eyebrow:'A new chapter begins', date:'Tuesday — September 1, 2026 / 7:00 PM', countdownTitle:'Until our day', days:'Days', hours:'Hours', minutes:'Minutes', seconds:'Seconds', storyKicker:'Two hearts, one beginning', storyTitle:'We would love to celebrate with you.', venueKicker:'The celebration', venueName:'Ashkan Garden', venueAddress:'Shiraz - Qalat Road - Aghaghia 2 Alley - Ashkan Garden', map:'Open location', mapKicker:'Navigation', mapTitle:'Choose your map', invitationText1:'This summer a very special and happy event is going to happen - our wedding!', invitationText2:'It is impossible to imagine this day without our closest people. Thus, we are happy to invite you to join and share this wonderful occasion with us!', rsvpTitle:'Will you be joining us?', rsvpTap:'Tap for respond', namePlaceholder:'Full name', attendanceQuestion:'Will you be joining us?', attendanceYes:"With love, I'll be there", attendanceNo:"I won't be able to join you this time", noteLabel:'Your note', notePlaceholder:'Write a message for us...', submitRsvp:'Send RSVP', rsvpSuccess:'Thank you for letting us know ♥', rsvpError:'Something went wrong. Please try again.', closingText:'Hope to see you there.', closingNames:'Niloufar and Saeed' },
  fa: { eyebrow:'آغاز یک فصل تازه', date:'سه‌شنبه — ۱۰ شهریور ۱۴۰۵ / ساعت ۱۹:۰۰', countdownTitle:'تا آغاز فصل عاشقی', days:'روز', hours:'ساعت', minutes:'دقیقه', seconds:'ثانیه', storyKicker:'دو قلب، یک آغاز', storyTitle:'دوست داریم این شب را در کنار شما جشن بگیریم.', venueKicker:'محل جشن', venueName:'باغ اشکان', venueAddress:'شیراز - ابتدای جاده قلات - کوچه اقاقیا ۲ - باغ اشکان', map:'مشاهده لوکیشن', mapKicker:'مسیریابی', mapTitle:'مسیریاب خود را انتخاب کنید', invitationText1:'تابستان امسال، اتفاقی بسیار خاص و شیرین قرار است رقم بخورد؛ عروسی ما!', invitationText2:'تصور این روز بدون حضور عزیزترین آدم‌های زندگی‌مان ممکن نیست. پس با خوشحالی از شما دعوت می‌کنیم تا در این مناسبت زیبا در کنار ما باشید و آن را با ما قسمت کنید!', rsvpTitle:'آیا در این شب کنار ما خواهید بود؟', rsvpTap:'برای پاسخ لمس کنید', namePlaceholder:'نام و نام خانوادگی', attendanceQuestion:'آیا در این شب کنار ما خواهید بود؟', attendanceYes:'با عشق، می‌آیم', attendanceNo:'متاسفانه نمی‌توانم همراه‌تان باشم', noteLabel:'یادداشت شما', notePlaceholder:'پیامتان را برای ما بنویسید...', submitRsvp:'ارسال پاسخ', rsvpSuccess:'ممنون که خبرمان کردید ♥', rsvpError:'مشکلی پیش آمد. لطفاً دوباره تلاش کنید.', closingText:'امیدواریم شما را در آنجا ببینیم.', closingNames:'نیلوفر و سعید' }
};
...
locationButton.addEventListener('click', event => { event.stopPropagation(); mapPopover.hidden ? openMapPicker() : closeMapPicker(); });
...
function openRsvp(){
  ...
  rsvpTap.setAttribute('aria-expanded','true');
  rsvpTap.style.display = 'none';
  setTimeout(() => rsvpForm.querySelector('input[name="name"]')?.focus(), 350);
}
rsvpTrigger.addEventListener('click', openRsvp);
rsvpTrigger.addEventListener('keydown', event => { if (event.key === 'Enter' || event.key === ' ') { event.preventDefault(); openRsvp(); } });
rsvpTap.addEventListener('click', openRsvp);
attendanceInputs.forEach(input => input.addEventListener('change', () => { $('attendanceLabel').value = input.nextElementSibling.textContent; }));
